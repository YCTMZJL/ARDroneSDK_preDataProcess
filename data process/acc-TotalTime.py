...
f2 = open(filepath+'X-AccelerationCali.csv','rb')
f3 = open(filepath+'Y-AccelerationCali.csv','rb')
f4 = open(filepath+'Z-AccelerationCali.csv','rb')
...
np.savetxt(savePath+'X-AccelerationCali.txt',np.hstack((totaltime,dataX)),fmt='%f',delimiter=' ')
np.savetxt(savePath+'Y-AccelerationCali.txt',np.hstack((totaltime,dataY)),fmt='%f',delimiter=' ')
np.savetxt(savePath+'Z-AccelerationCali.txt',np.hstack((totaltime,dataZ)),fmt='%f',delimiter=' ')