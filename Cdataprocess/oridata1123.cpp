...
int main()
{
	...
	strcat(readfilename1, "stable_Jonny_20161118_203114_GyrosZ.csv"); //accX Gyros
	strcpy(readfilename3, filepath);
	strcat(readfilename3, "stable_Jonny_20161118_203114_timeInterval.csv");
	//strcpy(savefilename, filepath);
	//strcat(savefilename, "CMean_stable_Jonny_20161118_203114_accZ");//*/
	strcpy(savefilename, "ori_stable_Jonny_20161118_203114_GyrosZ");
	...
	while (fin1 >> dataline && fin3 >> totaltimeline)//(fin1 >> dataline && fin2 >> timeline && fin3 >> totaltimeline)
	{
		...
		//{
			...
			timeInv.push_back(totaltimeline);
			Totaltime.push_back(totoltimesum);
